...
public class GeneticAlgorithm {
    ...
    public static int numR = 5;
    public static int numberRulesDataFile = 64;
    ...
    public static void main(String[] args) {
        ...
        while (genCounter < 500) {
            ...
            System.out.println(getTotalFitness(population, ind.popSize));
    ...
    public static Data[] readFile() {
        ...
        Scanner scan = new Scanner(GeneticAlgorithm.class.getResourceAsStream("dataSet2.txt"));
